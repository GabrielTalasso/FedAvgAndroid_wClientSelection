...
history = fl.simulation.start_simulation(client_fn=funcao_cliente, 
								...
								strategy=FedServer(aggregation_method='POC', fraction_fit = 1, num_clients = n_clients, 
					                                decay=0.1, perc_of_clients=0.10, dataset='MNIST', solution_name='POC', model_name='DNN'),
